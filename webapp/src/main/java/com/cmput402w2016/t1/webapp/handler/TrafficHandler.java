...
import com.cmput402w2016.t1.webapp.App;
        ...
        try {
            ...
            if (requestMethod.equalsIgnoreCase("POST")) {
                ...
                if (trafficData != null) {
                    ...
                    String from_hash = trafficData.getFrom().getClosestNode();
                    String to_hash = trafficData.getTo().getClosestNode();
